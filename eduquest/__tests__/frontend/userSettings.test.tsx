...
test('renders settings page with correct initial values', () => {
    ...
    expect(screen.getByLabelText('Student ID:').getAttribute('value')).toBe('12345678');
  });
  test('typing in input fields updates state', () => {
    ...
    fireEvent.change(screen.getByLabelText('Student ID:'), { target: { value: '09876543' } });
       ...
       expect(screen.getByLabelText('Student ID:').getAttribute('value')).toBe('09876543');
