    ...
    <main className="px-4 bg-gradient-to-b from-amber-100 to-amber-500 min-h-screen flex flex-col items-center justify-center">
      ...
      <div className="mt-8 text-center">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 text-white">
          <div className="text-3xl rounded-lg bg-blue-500 px-6 py-3">Ankkit Prakash</div>
          <div className="text-3xl rounded-lg bg-blue-500 px-6 py-3">Daniel Penner</div>
          <div className="text-3xl rounded-lg bg-blue-500 px-6 py-3">Mark Lovesey</div>
          <div className="text-3xl rounded-lg bg-blue-500 px-6 py-3">Nolan Nishikawa</div>
          <div className="text-3xl rounded-lg bg-blue-500 px-6 py-3">Rhys Smith</div>
        </div>
      </div>
      {/* Team Pixel Art */}
      <div className="mt-12">
      ...
      <div className="mt-8 text-center">
        ...
        <div className="mx-auto max-w-2xl text-white">
          <p className="text-3xl rounded-lg bg-blue-500 px-6 py-3">
