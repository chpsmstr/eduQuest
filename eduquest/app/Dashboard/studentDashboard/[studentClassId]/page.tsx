                ...
                <div className="col-span-6 row-start-1 row-end-10 bg-white text-black w-full rounded-lg">
                    ...
                    <div className="grid grid-cols-1 gap-6 justify-items-center">
                        ...
                        {classAssignments.map((element) =>(
                            ...
                            <button className="text-white bg-orange-400 px-2 py-2 text-2xl transition duration-500 hover:bg-orange-500 rounded"><strong>{element.assignmentName}</strong><br></br>Open: {element.startDate?.toString().split('GMT')[0]}<br></br>Due: {element.dueDate?.toString().split('GMT')[0]}</button>
                            </Link>
                        ))}
                    </div>
                </div>
