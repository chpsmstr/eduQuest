    ...
    <main className="px-9 bg-gradient-to-b from-amber-100 to-amber-500 h-screen flex items-center flex-col">
      ...
      <div className="grid text-center space-y-4 sm:space-y-0 lg:space-y-0  lg:grid-cols-2 sm:grid-cols-2 mt-6">
        <Link href="/Register/TeacherRegistration">
          <h1 className="text-3xl lg:text-4xl lg:mx-4 sm:mx-2 bg-red-600 p-4 rounded-md ">
            Teacher
          </h1>
        </Link>
        <Link href="/Register/StudentRegistration">
          <h1 className="text-3xl lg:text-4xl lg:mx-4 sm:mx-2 p-4 bg-indigo-800 rounded-md ">
            Student
          </h1>
        </Link>
      </div>
      ...
      <Link href="/Login">
        <h1 className="text-center text-2xl lg:text-2xl lg:mx-4 sm:mx-2 mt-6">
